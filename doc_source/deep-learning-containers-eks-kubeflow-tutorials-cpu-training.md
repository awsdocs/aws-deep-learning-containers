# CPU Training<a name="deep-learning-containers-eks-kubeflow-tutorials-cpu-training"></a>
...
1. Create a TFJob\.
   ...
   1. To start training, deploy the TFJob configuration file using `kubectl`\.
